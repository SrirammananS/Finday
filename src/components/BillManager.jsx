        ...
        <div className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-3">
                <div className="bg-gradient-to-br from-indigo-500/20 to-purple-500/20 rounded-xl p-3 border border-indigo-500/30">
                    <p className="text-xs text-slate-400">Monthly Bills</p>
                ...
                >
                    <div className="flex items-center justify-between mb-3">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="font-medium text-white">AI Detected {detectedBills.length} Recurring Bills</span>
                        </div>
                        <button
                            ...
                            >
                                {detectedBills.map((detected, idx) => (
                                    <div key={idx} className="flex items-center justify-between bg-slate-800/50 rounded-lg p-3">
                                        <div>
                                            <p className="text-white font-medium">{detected.name}</p>
            ...
            <div className="flex items-start justify-between">
                <div className="flex-1">
                    ...
                    <div className="flex items-center gap-3 mt-2">
                        <span className="text-lg font-bold text-white">₹{bill.amount?.toLocaleString()}</span>
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <div className="flex gap-1">
                        ...
                        <button
                            onClick={onDelete}
                            className="p-1.5 bg-slate-700 text-red-400 rounded-lg"
                        >
    ...
    return (
        ...
        >
            <motion.div
                ...
                animate={{ y: 0 }}
                exit={{ y: 100 }}
                className="bg-slate-900 rounded-t-3xl sm:rounded-2xl w-full sm:max-w-md max-h-[90vh] overflow-y-auto"
            ...
            >
                ...
                <form onSubmit={handleSubmit} className="p-4 space-y-4">
                    <div>
                        <label className="block text-sm text-slate-400 mb-1">Bill Name</label>
                        <input
                            type="text"
                            value={form.name}
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        ...
                        <div>
                            <label className="block text-sm text-slate-400 mb-1">Cycle</label>
                            <select
                                value={form.cycle}
                    ...
                    <div className="flex items-center justify-between py-2">
                        ...
                        <button
                            ...
                            className={`w-12 h-7 rounded-full transition-colors ${
                                form.reminder ? 'bg-indigo-500' : 'bg-slate-700'
                            }`}
                        >
                            <div className={`w-5 h-5 rounded-full bg-white transition-transform ${
                                form.reminder ? 'translate-x-6' : 'translate-x-1'
                            }`} />
                        </button>
                    </div>
