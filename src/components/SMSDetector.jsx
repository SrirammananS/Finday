...
const SMSDetector = ({ smsText, onClose, onSuccess }) => {
    ...
    if (!parsed || !form) {
        const noTxnContent = (
            ...
            >
                <motion.div
                    ...
                    className="w-full max-w-md bg-card border border-card-border rounded-2xl p-6 text-center"
                >
        ...
        return ReactDOM.createPortal(noTxnContent, document.body);
    }
        ...
        <>
            <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 overflow-hidden" data-modal-overlay>
                ...
                <motion.div
                    ...
                    onClick={e => e.stopPropagation()}
                    className="relative w-full max-w-lg bg-card border border-card-border rounded-t-3xl md:rounded-2xl overflow-hidden max-h-[90dvh] flex flex-col"
                >
                    {/* Header */}
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="flex justify-between items-center p-3 bg-canvas-subtle rounded-xl">
                                    ...
                                    <span className="text-sm font-bold text-text-main">
                                        {displayCategories.find(c => c.name === form.category)?.icon} {form.category}
                                    </span>
                                </div>
                                <div className="flex justify-between items-center p-3 bg-canvas-subtle rounded-xl">
