...
const SMSRulesManager = ({ isOpen, onClose, embedded = false }) => {
    ...
    const Content = (
        <div className={`bg-card w-full ${embedded ? '' : 'max-w-2xl max-h-[90vh] rounded-2xl border border-card-border shadow-2xl'} overflow-hidden flex flex-col h-full`}>
    ...
    return (
        <div className="fixed inset-0 z-[100] bg-black/80 backdrop-blur-sm flex items-center justify-center p-4" data-modal-overlay>
            <motion.div
