...
const Dashboard = () => {
    ...
    return (
        <>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                        ...
                        <div className="md:col-span-3 space-y-4">
                            ...
                            <div className="grid grid-cols-3 gap-2 md:gap-3">
                                ...
                                <button onClick={() => setIsSMSModalOpen(true)} className="relative overflow-hidden flex flex-col items-center gap-1.5 p-3 md:p-4 rounded-[1.5rem] bg-white/5 border border-white/10 hover:bg-white/10 transition-all group backdrop-blur-md">
                                    ...
                                    <span className="text-[8px] md:text-[9px] font-black uppercase tracking-widest text-text-muted group-hover:text-text-main transition-colors relative z-10 text-center leading-none">SMS Manage</span>
                                </button>
                            ...
                            <div className="hidden md:grid grid-cols-2 gap-3">
                                <motion.button whileHover={{ scale: 1.02 }} onClick={() => setIsSMSModalOpen(true)} className="relative overflow-hidden rounded-[2rem] p-5 bg-gradient-to-br from-primary/20 to-primary/5 border border-primary/20 text-left group">
                                    <div className="absolute top-0 right-0 p-8 bg-primary/20 blur-[40px] rounded-full" />
                                    <MessageSquare size={24} className="text-primary mb-3 relative z-10" />
                                    <p className="text-xs font-black uppercase tracking-widest text-text-main relative z-10">SMS Manager</p>
                                </motion.button>
            ...
            <AnimatePresence>
                {isSMSModalOpen && (
                    <SMSManager isOpen={isSMSModalOpen} onClose={() => setIsSMSModalOpen(false)} />
                )}
            </AnimatePresence>
        </>
    );
